...
-- Thời gian đã tạo: Th8 25, 2021 lúc 10:43 AM
...
CREATE TABLE IF NOT EXISTS `namhoc` (
  ...
  PRIMARY KEY (`maNH`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Năm học';
...
CREATE TABLE IF NOT EXISTS `phanconggiaovien` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'Mã phân công',
  ...
  PRIMARY KEY (`id`,`maGV`,`maLop`,`maMH`),
...
CREATE TABLE IF NOT EXISTS `phan_lop_hocsinh` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID phân lớp',
  `maHS` bigint(20) NOT NULL COMMENT 'Mã học sinh',
  `maLop` bigint(20) NOT NULL COMMENT 'Mã lớp',
  `maHK` bigint(20) NOT NULL COMMENT 'Mã học kỳ',
  PRIMARY KEY (`id`,`maHS`,`maLop`,`maHK`),
...
CREATE TABLE IF NOT EXISTS `taikhoan` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID tài khoản tạo Tự động',
  `username` varchar(50) COLLATE utf8_unicode_ci NOT NULL COMMENT 'Tên đăng nhập',
  `password` text COLLATE utf8_unicode_ci NOT NULL COMMENT 'Mật khẩu',
  `role` enum('student','teacher','leader','manager','admin') COLLATE utf8_unicode_ci NOT NULL DEFAULT 'student' COMMENT 'Vai trò trên trang',
  `email` varchar(100) COLLATE utf8_unicode_ci DEFAULT NULL COMMENT 'Địa chỉ Email',
  `maGV` bigint(20) DEFAULT NULL COMMENT 'Mã giáo viên',
  `maHS` bigint(20) DEFAULT NULL COMMENT 'Mã học sinh',
  PRIMARY KEY (`id`),
...
INSERT INTO `taikhoan` (`id`, `username`, `password`, `role`, `email`, `maGV`, `maHS`) VALUES
(1, 'admin', '21232f297a57a5a743894a0e4a801fc3', 'admin', NULL, NULL, NULL),
(2, 'quanly', '76ce09fc04225228897e61087b1172a8', 'manager', NULL, NULL, NULL),
(3, 'giaovien', '9fe9893ade1384ab1d48f52ab201723b', 'teacher', NULL, NULL, NULL),
(4, 'hocsinh', 'a953c428ceb5c5e8c0aba3f224edbd3f', 'student', NULL, NULL, NULL);
